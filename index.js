...
function addFlavor(flavor, array){
    let flavorAddedArray = [...array];
    flavorAddedArray.unshift(flavor);
    console.log(flavorAddedArray);
    return flavorAddedArray;
}

flavorsTwo = addFlavor('Rainbow Sherbert', originalFlavors);
console.log(flavorsTwo);
...
function removeLastFlavor(array){
    let flavorRemovedArray = [...array];
    flavorRemovedArray.pop();
    return flavorRemovedArray;
}

flavorsThree = removeLastFlavor(flavorsTwo);
console.log(flavorsThree);
...
console.log(copy(originalFlavors, "mutableOriginals"));
...
Write a function that checks every item in the array for a given string and returns a new array called filteredArray with just these values. Rather 
than hardcoding "chocolate" into your function, pass a string as a parameter, and invoke with the argument "chocolate". This way you could also 
filter for "Vanilla", "Sherbert", etc. when those holidays roll around.
